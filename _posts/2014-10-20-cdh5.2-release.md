...
- yarn-site.xml 中的以下参数改名：
 - mapreduce.shuffle to mapreduce_shuffle 改为 yarn.nodemanager.aux-services
...
在一个小集群中，设置 JobTracker heartbeat 间隔到一个更小的值，参数为 mapreduce.jobtracker.heartbeat.interval.min ，默认值为10
